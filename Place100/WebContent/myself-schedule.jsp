		...
		$(function() {
			...
			$("#add").click(function() {
				...
				$("#element").timeline("add", [{
					...
					css : 'success',
					content : '방문 목적 선택하기',
					select_name : 'purpose' + currTime,
					span_id : 'time' + currTime
				}]);
				currTime++;
			});
			...
			$('input[type=text]').on('click',function(){
				...
				childWindow = window.open(
						'storeSearch.action?name='+ name, 'new','resizable=no scrollbars=yes top=300 left=500 width=620 height=400');
			});
